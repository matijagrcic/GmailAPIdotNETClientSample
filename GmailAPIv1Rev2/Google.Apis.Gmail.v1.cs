...
//     Build date: 2014-06-09 16:41:44 UTC
//     on: 2014-06-25, 19:14:00 UTC
//     C# generater version: 
//
 ...
 *      <tr><th>Generated At<td>2014-06-25 19:14:00 UTC
 *      <tr><th>C# Generator<td>google-apis-code-generator
 *      <tr><th>Generator Version
 *          <td>1.4.3 / c#=1.8.1
 *      <tr><th>Generator Build<td>2014-06-09 16:41:44 UTC
 *    </table>
 *
...
{    
    ...
    /// <summary>A record of a change to the user's mailbox. Each history contains a list of the messages that were
    /// affected by this change.</summary>
    public class History : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The messages that changed in this history record.</summary>
    ...
    {
        /// <summary>List of history records.</summary>
    ...
    public class Message : Google.Apis.Requests.IDirectResponseSchema
    {
        ...
        /// <summary>The entire email message in an RFC 2822 formatted string. Returned in messages.get and drafts.get
        /// responses when the format=RAW parameter is supplied.</summary>
        ...
        /// with your request. - The References and In-Reply-To headers must be set in compliance with the </summary>
    ...
    public class UsersResource
    {
        ...
        public class HistoryResource
        {
            ...
            public class ListRequest : GmailBaseServiceRequest<Google.Apis.Gmail.v1.Data.ListHistoryResponse>
            {
                ...
                /// code. A historyId is typically valid for at least a week, but in some circumstances may be valid for
                /// only a few hours. If you receive an HTTP 404 error response, your application should perform a full
                /// sync. If you receive no nextPageToken in the response, there are no updates to retrieve and you can
                /// store the returned historyId for a future request.</summary>
        ...
        public class MessagesResource
        {
            ...
            /// <summary>Directly imports a message into only this user's mailbox, similar to receiving via SMTP. Does
            /// not send a message.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated
            /// user.</param>
            ...
            /// <summary>Directly imports a message into only this user's mailbox, similar to receiving via SMTP. Does
            /// not send a message.</summary>/// <param name="body">The body of the request.</param>
            /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated
            /// user.</param>
            /// <param name="stream">The stream to upload.</param>
            /// <param name="contentType">The content type of the stream to upload.</param>
            ...
            /// <summary>Directly inserts a message into only this user's mailbox. Does not send a message.</summary>
            /// <param name="body">The body of the request.</param>
            /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated
            /// user.</param>
            ...
            /// <summary>Directly inserts a message into only this user's mailbox. Does not send a message.</summary>/// <param name="body">The body of the request.</param>
            /// <param name="userId">The user's email address. The special value me can be used to indicate the authenticated
            /// user.</param>
            /// <param name="stream">The stream to upload.</param>
            /// <param name="contentType">The content type of the stream to upload.</param>
